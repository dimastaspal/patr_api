...
from patr_api_app.views import AllNewsView, AllEventsView, AllStaffView, AllDocsView, AllPartnersView, AllVideosView, \
    AllParkView, index

router = SimpleRouter(trailing_slash=False)


router.register('patr_api/allnews', AllNewsView)
router.register('patr_api/allevents', AllEventsView)
